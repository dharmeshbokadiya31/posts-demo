  ...
  return (
    <div className="bg-white rounded-lg overflow-hidden flex flex-col h-full border" key={item.id}>
        ...
        <div className="p-4">
            ...
            <div className="flex items-center gap-2 cursor-pointer" onClick={() => commentSection(item.id, item.reactions)}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                ...
                <span className="text-gray-800 font-semibold">{item.reactions} Comments</span>
            </div>
            </div>
            {showComments &&
            <>
